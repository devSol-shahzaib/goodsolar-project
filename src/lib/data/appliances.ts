...
export const appliances: Appliance[] = [
  { id: "ac-1", name: "Air Conditioner (1-ton)", wattage: 1300, defaultHours: 8 },
  { id: "ac-1.5", name: "Air Conditioner (1.5-ton)", wattage: 1800, defaultHours: 8 },
  { id: "ac-2", name: "Air Conditioner (2-ton)", wattage: 2400, defaultHours: 8 },
  { id: "fan", name: "Ceiling Fan", wattage: 75, defaultHours: 12 },
  { id: "led-light", name: "LED Light (per room)", wattage: 20, defaultHours: 6 },
  { id: "fridge", name: "Refrigerator", wattage: 150, defaultHours: 24 },
  { id: "tv", name: "LED TV", wattage: 100, defaultHours: 4 },
  { id: "washing-machine", name: "Washing Machine", wattage: 500, defaultHours: 1 },
